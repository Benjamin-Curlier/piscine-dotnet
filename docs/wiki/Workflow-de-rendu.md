...
3. Elle détecte les exercices **présents** dans le rendu, les corrige **par groupe, dans l'ordre,
   arrêt au premier échec** (suivants → *Non corrigé*). Voir [Moulinette](Moulinette).
4. Le feedback éducatif est imprimé pendant le push **et** la progression est persistée.
