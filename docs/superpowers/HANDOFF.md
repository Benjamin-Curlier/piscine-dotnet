...
- **Tests** : 247 verts (`dotnet test Piscine.slnx -c Release` : Core 46 + App 51 + Components 24 + Git 7 +
  DevHost.E2E 8 + Grading 111). CI GitHub Actions verte sur `main`. (164 avant v4 ; +3 S1 ; +2 S2 ; +26 S3 ;
  +9 S4 ; +15 S5 ; +6 S6 ; +10 S7 ; +11 S8 ; S9 packaging +0 ; +1 S9b = indirection render modes.)
