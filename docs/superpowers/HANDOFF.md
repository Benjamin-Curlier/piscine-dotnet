...
- **Tests** : 257 verts (`dotnet test Piscine.slnx -c Release` : Core 46 + App 57 + Components 25 + Git 9 +
  DevHost.E2E 9 + Grading 111). CI GitHub Actions verte sur `main`. (164 avant v4 ; +83 v4 S1→S9b ;
  +6 v5 S11 résultat riche ; +4 v5 S12 = ShimLocator 2 + TerminalPolicy 2.) **Linux (PTY/coaching/shim)
  prouvé via Docker `dotnet/sdk:10.0`** (57/57 App tests) en S12.
