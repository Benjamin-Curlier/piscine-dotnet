...
- **Tests** : 204 verts (`dotnet test Piscine.slnx -c Release` : Core 46 + App 32 + Components 4 + Git 7 +
  DevHost.E2E 4 + Grading 111). CI GitHub Actions verte sur `main`. (164 avant v4 ; +3 S1 ; +2 S2 ; +26 S3 ;
  +9 S4 = CheckService 5 + CheckFeedback bUnit 3 + E2E /check 1.)
...
## v4 — application desktop Photino (S1 → S4 FAITS ✅, S5 à suivre)
...
- ⏭ **#26 S5** = **navigation d'exercices + progression** (lister modules/exos, statut par exo, lien vers `/check`).
