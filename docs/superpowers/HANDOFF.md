...
- **Tests** : 219 verts (`dotnet test Piscine.slnx -c Release` : Core 46 + App 39 + Components 11 + Git 7 +
  DevHost.E2E 5 + Grading 111). CI GitHub Actions verte sur `main`. (164 avant v4 ; +3 S1 ; +2 S2 ; +26 S3 ;
  +9 S4 ; +15 S5 = ProgressService 7 + StatusBadge bUnit 7 + E2E /progress 1.)
...
## v4 — application desktop Photino (S1 → S5 FAITS ✅, S6 à suivre)
...
- ⏭ **#27 S6** = **lecteur de cours/sujets (RCL) + parité mode sombre** (rendu riche du cours dans l'app, thème sombre comme le site).
