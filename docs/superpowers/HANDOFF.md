...
- **Tests** : 253 verts (`dotnet test Piscine.slnx -c Release` : Core 46 + App 53 + Components 25 + Git 9 +
  DevHost.E2E 9 + Grading 111). CI GitHub Actions verte sur `main`. (164 avant v4 ; +83 v4 S1→S9b ;
  +6 v5 S11 = résultat de push riche : Git 2 + App 2 + bUnit 1 + E2E 1.)
...
- ⏭ **#45 S12 — Terminal + coaching git dans Photino** (+ packager `GitShim` ; confirmer Linux via WSL/Docker).
